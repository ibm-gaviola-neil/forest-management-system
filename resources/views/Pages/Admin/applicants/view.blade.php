...
<div class="container mx-auto px-4 py-8">
  ...
  <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
      <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
          <div>
              <h1 class="text-2xl font-bold text-gray-900">Applicant Profile</h1>
              <p class="mt-1 text-sm text-gray-500">Complete profile information and applications</p>
          </div>
  ...
  <div class="flex justify-end space-x-4 mt-6">
      <a href="{{ route('admin.applicants') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
      ...
      @if(auth()->user()->role === 'general_admin' || auth()->user()->role === 'admin')
          ...
          <a href="{{ route('admin.applicants.edit', $user_profile->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              <i class="fas fa-edit mr-2"></i> Edit Profile
          </a>
      @endif
  </div>
