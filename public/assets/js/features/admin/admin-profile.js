...
if (profileEditForm) {
    profileEditForm.addEventListener('submit', async (e) =>{
        ...
        try {
            ...
            redirectModal('Profile updated updated successfully!', '/admin/profile');
        } catch (error) {
...
if (uploadPicForm) {
    uploadPicForm.addEventListener('submit', async (e) =>{
        ...
        try {
            ...
            redirectModal('Profile image updated successfully!', '/admin/profile');
        } catch (error) {
