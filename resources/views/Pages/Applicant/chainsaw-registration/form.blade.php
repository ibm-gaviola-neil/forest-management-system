    ...
    <div class="space-y-6 col-span-2">
        ...
        <div class="flex flex-col">
            <div class="space-y-2 mb-5">
                ...
                <div class="bg-blue-50 p-3 rounded-md text-sm text-blue-800 mb-3">
                    <h4 class="font-semibold mb-1"><i class="fas fa-info-circle mr-1"></i> Required Documents:</h4>
                    <ul class="list-disc pl-5 space-y-1">
                        <li>Official Receipt or Proof of Purchase</li>
                        <li>Valid government-issued ID of the owner</li>
                        <li>Clear photos of the chainsaw from multiple angles (front, side, back)</li>
                        <li>Close-up photo of the chainsaw's serial number</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="relative">
                <input type="file" id="document" name="documents[]"
                    accept="application/pdf,image/jpeg,image/jpg,image/png,.pdf,.jpg,.jpeg,.png" class="hidden"
                    multiple />
                <!-- Removed required attribute -->

                <label for="document"
                    class="flex items-center justify-center w-full px-4 py-3 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition duration-300">
            ...
            <span id="documents_Error" class="mt-1 text-xs italic text-red-500"></span>
        </div>
    </div>
</div>
        ...
        function displaySelectedFiles() {
            ...
            for (let i = 0; i < selectedFiles.files.length; i++) {
                ...
                fileElement.className =
                    'flex items-center justify-between p-2 bg-gray-50 border border-gray-200 rounded';
