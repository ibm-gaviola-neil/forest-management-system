...
<div id="personal-info" class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
    ...
    <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
        <form id="profileEditForm">
            ...
            <div class="mt-6">
                <a href="/admin/applicants/view/{{$user_profile->id}}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
@push('scripts')
<script src="{{asset('./assets/js/features/admin/edit-profile.js')}}" type="module"></script>
@endpush
@endsection