                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name">Louis Henry <small class="float-right text-muted">38min
                                                ago</small></span>
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media mb-0">
                                    ...
                                    <div class="media-body">
                                        <span class="name">Debra Stewart <small class="float-right text-muted">2hr
                                                ago</small></span>
                ...
                {{-- <li class="dropdown language-menu">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item pt-2 pb-2" href="#"><img
                                src="../assets/images/flag/russia.svg " class="w20 mr-2 rounded-circle"> Russian</a>
                        <a class="dropdown-item pt-2 pb-2" href="#"><img
                                src="../assets/images/flag/arabia.svg " class="w20 mr-2 rounded-circle"> Arabic</a>
                        <a class="dropdown-item pt-2 pb-2" href="#"><img
                                src="../assets/images/flag/france.svg " class="w20 mr-2 rounded-circle"> French</a>
                    </div>
                </li>
