                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Your application is currently being reviewed by our environmental team.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                        ...
                        <div class="border-t border-gray-200 p-4 space-y-3">            
                            <button class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                            onclick="openModal()"
                            @if ($cutting_permit->status !== 0)
                                disabled
                            @endif>
...
@include('Pages.Applicant.cutting-permit.cancel-modal')
@push('scripts')
