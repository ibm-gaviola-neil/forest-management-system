...
@section('applicant-content')
    ...
    <a href="/applicant/treeRegistration" class="bg-green-500 hover:bg-green-600 text-white p-10 rounded-2xl shadow-lg flex items-center justify-between text-2xl h-56">
        <div>
    ...
    <a href="/applicant/chainsaw" class="bg-blue-400 hover:bg-blue-500 text-white p-10 rounded-2xl shadow-lg flex items-center justify-between text-2xl h-56">
        <div>
    ...
    <a href="/applicant/cutting" class="bg-red-400 hover:bg-red-500 text-white p-10 rounded-2xl shadow-lg flex items-center justify-between text-2xl h-56">
        <div>
    ...
    <a href="/applicant/requirements" class="bg-gray-300 hover:bg-gray-400 text-white p-10 rounded-2xl shadow-lg flex items-center justify-between text-2xl h-56">
        <div>
    ...
    <!-- Box 5: View Permits -->
    <a href="/applicant/permit" class="bg-orange-300 hover:bg-orange-400 text-white p-10 rounded-2xl shadow-lg flex items-center justify-between text-2xl h-56">
        <div>
