...
>
  <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
    ...
    <!-- Modal Title & Text -->
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-2">Approve Cutting Permit Application?</h2>
    <p class="text-center text-gray-600 mb-6">
      Are you sure you want to <span class="text-red-500 font-semibold">approve</span> cutting permit application? This action cannot be undone.
    </p>
    
    <!-- Action Buttons -->
    <div class="flex space-x-4 justify-center">
      <button 
        class="px-5 py-2 bg-green-600 text-white rounded hover:bg-green-700 font-semibold transition" id="approve-btn" value="{{$cutting_permit->id}}"
      >
        Approve
      </button>
      <button 
